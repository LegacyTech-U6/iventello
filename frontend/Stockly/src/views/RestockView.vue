          ...
          <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg border border-gray-200 p-6 mb-6">
              ...
              <div class="flex gap-4 mb-6">
                <img :src="product?.Prod_image || 'https://via.placeholder.com/80'" :alt="product?.Prod_name"
              ...
              <div class="space-y-3 text-sm border-t border-gray-200 pt-4">
                <div class="flex justify-between">
                  <span class="font-medium text-gray-900" :style="getDynamicStyle(product?.cost_price || 0)">{{
                    format(product?.cost_price || 0) }}</span>
                </div>
                <div class="flex justify-between">
            ...
            <div class="space-y-6">
              ...
              <div>
                ...
                <div class="flex items-center gap-3">
                  ...
                  <input type="number" v-model.number="quantity" @input="validateQuantity"
              ...
              <!-- Unit Cost -->
              <div>
                <label class="block text-sm font-medium text-gray-900 mb-3"> Unit Cost ({{ currency }}) </label>
                <div class="relative">
                  <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500">{{ currency === 'USD' ? '$' :
                    currency }}</span>
                  <input type="number" v-model.number="unitCost"
              ...
              <div>
                ...
                <textarea v-model="notes" placeholder="Additional notes about this restock..."
              ...
              <div class="space-y-4 mb-6">
                ...
                <div class="p-4 bg-orange-50 rounded-lg">
                  ...
                  <p class="text-2xl font-bold text-orange-600"
                    :style="getDynamicStyle(quantity * product?.cost_price)">
                    {{ format(quantity * product?.cost_price) }}
                  </p>
                </div>
              </div>
...
const { format, getDynamicStyle, currency } = useCurrency()
