  ...
  <div
    ...
    <div class="flex items-start gap-4 mb-4">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="badge-success inline-flex items-center gap-1.5" title="Number of products in this category">
      ...
      <div class="flex gap-1">
        <button
          ...
          @click.stop="$emit('edit', category)" title="Edit">
        ...
        <button
          ...
          @click.stop="$emit('delete', category.id)" title="Delete">
    ...
    <div class="flex justify-between items-center text-sm text-on-surface-variant">
      <div class="flex items-center gap-2" title="Creation Date">
        <CalendarDaysIcon class="w-4 h-4 text-tertiary" />
...
<script setup>
import { PencilIcon, TrashIcon, CubeIcon, CalendarDaysIcon, ClockIcon } from '@heroicons/vue/24/outline'
