<template>
    <div class="bg-white rounded-xl shadow-lg border border-gray-100 p-6 sticky top-4">
        <h2 class="text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
            <PhotoIcon class="w-6 h-6 text-red-500" />
            Media
        </h2>

        <div class="aspect-square rounded-xl mb-4 flex items-center justify-center overflow-hidden group border-4"
            ...
            <div v-else class="text-center p-8">
                <NoSymbolIcon class="w-12 h-12 text-gray-300 mb-3 mx-auto" />
        ...
        <div class="flex gap-2 justify-center">
            ...
            <button
                ...
                <CameraIcon class="w-6 h-6 text-gray-400 group-hover:text-blue-500" />
            </button>
...
import { PhotoIcon, NoSymbolIcon, CameraIcon } from '@heroicons/vue/24/outline'
